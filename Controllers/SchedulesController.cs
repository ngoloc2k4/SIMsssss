...
namespace SIM_Project.Controllers
{
    public class SchedulesController : Controller
    {
        ...
        {
            var applicationDbContext = _context.Schedules.Include(s => s.Course).Include(s => s.Teacher);
        ...
        public async Task<IActionResult> Create([Bind("ScheduleID,Date,CourseID,TeacherID")] Schedule schedule)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ScheduleID,Date,CourseID,TeacherID")] Schedule schedule)
        {
